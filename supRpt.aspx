<%@ Page Language="C#" AutoEventWireup="true" CodeFile="supRpt.aspx.cs" Inherits="supRpt" %>
...
<body style="width: 1276px; height: 1111px; margin-right: 2px; margin-left: 0px; margin-top: 0px;">
   <form id="form1" runat="server">
    ...
    <div style="margin-top: 2px;  width: 1276px;">
         ...
         <br />
           ...
           <div style="width: 1272px; background-color: #FFFFFF; color: #FFFFFF; background-image: url('Image/Rpt1.jpg'); height: 536px;";>
                  ...
                  <div style="text-align:center">
                      <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Overline="True" Font-Size="XX-Large" Font-Strikeout="False" Font-Underline="True" ForeColor="Black" Text="SUPPLIER REPORT"></asp:Label>
        ...
        <div>
                           <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="10pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="16pt" style="margin-left: 110px" Width="1038px">
                               <localreport reportpath="supRpt.rdlc">
                                   <datasources>
                                       <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="DataSet1" />
                                   </datasources>
                               </localreport>
                           </rsweb:ReportViewer>
                           <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetData" TypeName="OSDBDataSetTableAdapters.SupTblTableAdapter"></asp:ObjectDataSource>
               <br />
