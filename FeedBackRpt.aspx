<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FeedBackRpt.aspx.cs" Inherits="FeedBackRpt" %>
         ...
         <br />
           ...
           <div style="width: 1272px; background-color: #FFFFFF; color: #FFFFFF; background-image: url('Image/Rpt1.jpg'); height: 536px;";>
                  ...
                  <div style="text-align:center">
                      <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Overline="True" Font-Size="XX-Large" Font-Strikeout="False" Font-Underline="True" ForeColor="Black" Text="FEEDBACK REPORT"></asp:Label>
...
>
               ...
               <br />
               <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" style="margin-left: 201px" Width="852px" >
                   <LocalReport ReportPath="feedback.rdlc">
                       <DataSources>
                           <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="DataSet1" />
                       </DataSources>
                   </LocalReport>
            </rsweb:ReportViewer>
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetData" TypeName="OSDBDataSetTableAdapters.FeedBackTableAdapter"></asp:ObjectDataSource>
            <br />
            <br />
            <br />
